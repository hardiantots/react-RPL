                    ...
                    <main className="bg-white-300 flex-1 overflow-hidden mb-6">
                        ...
                        <div className="flex flex-col mt-20 md:mt-0 mr-2">
                            ...
                            <div className="flex flex-1 flex-col lg:mr-20 lg:ml-20 ml-6 mr-3 mb-6 justify-between content-center bg-white px-6 py-4 rounded-lg">
                                <form>
                                    <div class="mb-6">
                                        <label for="paketmenu" className="block mb-2 text-md font-bold text-[#F77E21] text-start">NAMA TOKO KATERING</label>
                                        <input type="text" id="text" className="bg-gray-50 border border-gray-400 text-gray-900 text-sm rounded-lg block w-full p-2.5" placeholder="Nama Toko Katering"/>
                                    </div>
                                    ...
                                    <div class="mb-6">
                                        <label for="message" className="block mb-2 text-md font-bold text-[#F77E21] text-start">E-MAIL</label>
                                    ...
                                    <div className="flex gap-4 mt-8">
                                        ...
                                        <Link to="/listadminpage" className="btn bg-red-600 text-white text-xs md:text-sm font-semibold py-2 rounded-lg w-full text-center">
                                            Batalkan
                                        </Link>
                                    </div>
                                </form>
