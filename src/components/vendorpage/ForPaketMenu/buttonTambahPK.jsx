...
import ModalTambahPK from "./modalTambahPK"

export default function ButtonTambahPK() {
    ...
    return(
        ...
        <ModalTambahPK open={open} onClose={() => setOpen(false)}>
            <div className="mx-auto my-4 w-40 md:w-60">
                <p className="text-xl font-bold text-[#F77E21] mb-6">Tambah Paket Menu</p>
            </div>
